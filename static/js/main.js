...
window.onload = function() {
    ...
    var SceneGame = Class.create(Scene, {
        ...
        initialize: function() {
            ...
            // 4 - Add child nodes
            this.addChild(bg);
            this.addChild(new Carte(game.width * .5 - 192 * .5 - 192 / 2 * .25, 20, 2, 0, true));
            this.addChild(new Carte(game.width * .5 - 192 * .5 + 192 / 2 * .25, 20, 5, 2, true));
            this.addChild(new Carte(game.width * .5 - 192 * .5 - 192 / 2 * .25, 20 + 279 * .25, 8, 1, false));
            this.addChild(new Carte(game.width * .5 - 192 * .5 + 192 / 2 * .25, 20 + 279 *.25, 1, 3, false));
            this.addChild(label);
